 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "<br><br>\n",
    "2. **Data Catalogue**. Where possible, all dataets used in the production of Data Goods are added as entries to the World Bank's [Development Data Hub](https://datacatalog.worldbank.org/home), where they are tagged with meta data, license attributes, and access information. \n",
    "<br><br>\n",
