...
class CHIRPSRainfallExtractor:
    ...
    def __init__(
        self, output_dir="../data/rainfall", boundaries_dir="../data/boundaries"
    ):
        """
        ...
        logger.info(
            f"Initialized CHIRPSRainfallExtractor with output_dir: {self.output_dir}"
        )
    ...
    def load_myanmar_boundaries(self, admin_level=1):
        ...
        logger.info(
            f"Loading Myanmar ADM{admin_level} boundaries from {shapefile_path}"
        )
    ...
    def get_rainfall_data(self, start_date, end_date, temporal_resolution="monthly"):
        ...
        chirps = (
            ...
            .filterBounds(self.myanmar_geom)
        )
    ...
    def get_rainfall_by_region(
        ...
        """
        logger.info(
            f"Extracting CHIRPS rainfall by region using column: {admin_column}"
        )
