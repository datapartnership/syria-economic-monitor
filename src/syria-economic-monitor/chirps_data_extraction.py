...
def get_chirps_rainfall_by_region(start_date, end_date, regions_gdf, 
    ...
    filename = f"myanmar_chirps_rainfall_{start_date}_{end_date}_{temporal_resolution}.csv"
...
def main():
    ...
    service_account_file = '/Users/ssarva/myanmar-economic-monitor/training-253313-c905674c1ca0.json'
    ...
    logger.info("="*60)
    boundaries_path_adm0 = '../../data/boundaries/mmr_polbnda_adm0_250k_mimu_20240215.shp'
    ...
    logger.info("="*60)
    boundaries_path_adm1 = '../../data/boundaries/mmr_polbnda_adm1_250k_mimu_20240215.shp'
