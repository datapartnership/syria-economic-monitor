...
from airpollution_visuals import create_interactive_lineplot, load_airpollution_data, quick_national_plot
import pandas as pd
    ...
    try:
        ...
        for key, df in datasets.items():
            ...
            if not df.empty:
                ...
                print(f"  Categories: {df['NAME_EN'].unique()[:5]}...")  # Show first 5 categories
