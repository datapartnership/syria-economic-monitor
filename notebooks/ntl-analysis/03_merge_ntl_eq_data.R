...
# ADM3 -------------------------------------------------------------------------
ntl3_v1_df <- read_csv(file.path(ntl_bm_dir, "FinalData", "aggregated", "syr_temp", "syr_admin_adm3_daily.csv"))
...
# ADM4 -------------------------------------------------------------------------
ntl4_v1_df <- read_csv(file.path(ntl_bm_dir, "FinalData", "aggregated", "syr_temp", "syr_admin_adm4_daily.csv"))
