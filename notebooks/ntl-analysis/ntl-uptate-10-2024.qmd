...
ntl_months <- seq.Date(ymd("2018-01-01"), to = ymd("2024-06-01"), by = "month") %>%
  as.character()
    ...
    for(time_i in time_vec){
      ...
      if(!file.exists(OUT_FILE)){
        ...
        if(unit == "bordercrossings"){
          roi_sf <- st_read(file.path(data_dir, "Border Crossing Locations - All", 
                                      "FinalData",
                                      "border_crossings_1500m.shp"))
        }
